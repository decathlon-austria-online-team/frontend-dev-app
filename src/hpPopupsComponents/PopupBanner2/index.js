...
export default function PopupBanner2(props) {
  ...
  const [rightSide2TopLinkText, setRightSide2TopLinkText] = useState("");
  const rightSide2TopLinkTextHandleOnChange = (e) => {
    setRightSide2TopLinkText(e.target.value);
  };
  ...
  const [rightSide2BottomLinkText, setRightSide2BottomLinkText] = useState("");
  const rightSide2BottomLinkTextHandleOnChange = (e) => {
    setRightSide2BottomLinkText(e.target.value);
  };
  ...
  const generateCodeFunc = () => {
    ...
    if(props.userDataObjFromSheet.languageType === "LTR") {
      ...
      .mobile-additinal-links-section__productContiner a {
       position: absolute;
       top: 10px;
     }
      ...
      @media (min-width: 1200px) {
       ...
       <div class="newHpContainer">
         <div class="swiper-container swiper-container__banner2">
   ...
   <script>
           var swiper = new Swiper(".swiper-container__banner2", {
           slidesPerView: 1,
           spaceBetween: 0,
        ...
        <Fade in={props.open}>
          <div className={classes.paper}>
            ...
            <div className="popupInputsContainer">
              ...
              <div className="popupInputsContainer__sectionWrapper">
                <p className="popupInputsContainer__titleOfInputsGroup">
                  desktop slide 1 - right side top
                </p>
                <div className="popupInputsContainer__wrapper">
                  <TextField
                    id="standard-basic"
              ...
              <div className="popupInputsContainer__sectionWrapper">
                <p className="popupInputsContainer__titleOfInputsGroup">
                  desktop slide 1 - right side bottom
                </p>
                <div className="popupInputsContainer__wrapper">
                  <TextField
                    id="standard-basic"
              ...
              <div className="popupInputsContainer__sectionWrapper">
                <p className="popupInputsContainer__titleOfInputsGroup">
                  desktop slide 2 - right side top
                </p>
                <div className="popupInputsContainer__wrapper">
                  <TextField
                    id="standard-basic"
                ...
                <div className="popupInputsContainer__wrapper">
                  <TextField
                    ...
                    label="link text"
                    style={{ width: "80%" }}
                    onChange={rightSide2TopLinkTextHandleOnChange}
                  />
                </div>
                <div className="popupInputsContainer__wrapper">
                  <TextField
              ...
              <div className="popupInputsContainer__sectionWrapper">
                <p className="popupInputsContainer__titleOfInputsGroup">
                  desktop slide 2 - right side bottom
                </p>
                <div className="popupInputsContainer__wrapper">
                  <TextField
                    id="standard-basic"
                ...
                <div className="popupInputsContainer__wrapper">
                  <TextField
                    ...
                    label="link text"
                    style={{ width: "80%" }}
                    onChange={rightSide2BottomLinkTextHandleOnChange}
                  />
                </div>
                <div className="popupInputsContainer__wrapper">
                  <TextField
