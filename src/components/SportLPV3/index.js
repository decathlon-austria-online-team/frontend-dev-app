...
import PopupProductsSlider1V3 from "../../sportLpPopupComponents/PopupProductsSlider1V3";
...
const SportLPV3 = (props) => {
  ...
  const [imgData, setImgData] = useState([
    ...
    {
      img: screenshotProductSliderWithVariant,
      title: "Product slider with variants",
      type: "page component",
      onclick: () => setOpenProductsSlider1V3Component(true),
    },
    /* {
      img: codeImage,
  ...
  const [openProductsSlider1V2Component, setOpenProductsSlider1V2Component] =
    useState(false);

  const [openProductsSlider1V3Component, setOpenProductsSlider1V3Component] =
    useState(false);
    ...
    <div className="sportLPV3 page">
      ...
      <div className="sportLPV3__popups">
        ...
        <PopupProductsSlider1V2
          ...
          userDataObjFromSheet={props.userDataObjFromSheet}
        />
        <PopupProductsSlider1V3
          imgUrl={screenshotProductSliderWithVariant}
          open={openProductsSlider1V3Component}
          handleClose={() => setOpenProductsSlider1V3Component(false)}
          userDataObjFromSheet={props.userDataObjFromSheet}
        />
